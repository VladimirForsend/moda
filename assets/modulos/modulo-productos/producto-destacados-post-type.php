                    ...
                    <div class="comercio-product-card col-12">
                        <a href="<?php echo get_permalink($loop->post->ID) ?>">
                            <?php if (has_post_thumbnail()) : ?>
                                <div class="tarjeta-producto-superior w-100" style="background-image: url('<?php echo wp_get_attachment_url(get_post_thumbnail_id($post->ID)); ?>');">
                                    ...
                                    <div class="tarjeta-producto-inferior w-100">
                                        ...
                                        <?php endif; ?>
                                        <?php endif; ?>
                                        <div class="boton-detalle">Ver detalles</div>
                                    </div>
                                </div>
                        </a>
                    </div>
