...
function carrusel_logos() {
	...
	$labels = array(
		'name'                  => _x( 'carrusel logos', 'Post Type General Name', 'carrusel_logos' ),
		'singular_name'         => _x( 'carrusel logo', 'Post Type Singular Name', 'carrusel_logos' ),
		'menu_name'             => __( 'carrusel logos', 'carrusel_logos' ),
		'name_admin_bar'        => __( 'carrusel logos', 'carrusel_logos' ),
		'archives'              => __( 'carrusel logos', 'carrusel_logos' ),
		'attributes'            => __( 'carrusel logos', 'carrusel_logos' ),
		'parent_item_colon'     => __( 'Basado en:', 'carrusel_logos' ),
		'all_items'             => __( 'Todas los logos', 'carrusel_logos' ),
		'add_new_item'          => __( 'Agregar nuevo logo', 'carrusel_logos' ),
		'add_new'               => __( 'Agregar nueva', 'carrusel_logos' ),
		'new_item'              => __( 'nuevo carrusel logo', 'carrusel_logos' ),
		'edit_item'             => __( 'editar carrusel logo', 'carrusel_logos' ),
		'update_item'           => __( 'actualizar', 'carrusel_logos' ),
		'view_item'             => __( 'Ver carrusel logo', 'carrusel_logos' ),
		'view_items'            => __( 'ver el carrusel logo', 'carrusel_logos' ),
		'search_items'          => __( 'buscar en carrusel logo', 'carrusel_logos' ),
