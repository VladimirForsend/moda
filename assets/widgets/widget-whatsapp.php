...
// Creating the widget 
class comercio_custom_widget extends WP_Widget {
  
function __construct() {
parent::__construct(
  
// Base ID of your widget
'comercio_custom_widget', 
  
// Widget name will appear in UI
__('Whatsapp Botón', 'comercio_custom_widget_domain'), 
  
// Widget description
array( 'description' => __( 'Boton de whatsapp, listo para ingresar tu número y que lleguen consultas a tu sitio web', 'comercio_custom_widget_domain' ), ) 
);
}
...
$title = __( 'Número de WhatsApp sin espacios sin +56', 'comercio_custom_widget_domain' );
}
// Widget admin form
?>
<p>
...
// Class comercio_custom_widget ends here
} 
 
 
// Register and load the widget
function wpb_load_widget() {
    register_widget( 'comercio_custom_widget' );
}
